...
public class IntFormulaOneFragment extends Fragment {

    public final static String TITLE = "Formula One";

    public final static String STORAGE_NAME = "formula_one_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_int_formula_one, container, false);
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.int_formular_one_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.int_formular_one_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.int_formular_one_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.int_formular_one_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.int_formular_one_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.int_formular_one_view_btn_retry);
