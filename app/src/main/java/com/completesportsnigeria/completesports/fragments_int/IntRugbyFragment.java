...
public class IntRugbyFragment extends Fragment {

    public final static String TITLE = "Rugby";

    public final static String STORAGE_NAME = "int_rugby_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_int_rugby, container, false);
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.int_rugby_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.int_rugby_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.int_rugby_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.int_rugby;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.int_rugby_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.int_rugby_view_btn_retry);
