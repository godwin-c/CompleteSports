...
public class IntNewsFragment extends Fragment {
    ...
    public final static String STORAGE_NAME = "int_news_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_int_news, container, false);
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.int_news_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.int_news_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.int_news_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.int_news_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.int_news_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.int_news_view_btn_retry);
