...
public class CricketSportsFragment extends Fragment {
    public final static String TITLE = "Cricket";

    public final static String STORAGE_NAME = "cricket_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_cricket_sports, container, false);
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.cricket_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.cricket_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.cricket_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.cricket_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.cricket_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.cricket_view_btn_retry);
    ...
    private ArrayList<FeedItem> readFromStorage(String address) {
        ...
        try {
            ...
            Log.d("Read Store Cricket", String.valueOf(e));
            // reply = false;
        }
