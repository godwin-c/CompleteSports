...
public class IntGolfFragment extends Fragment {

    public final static String TITLE = "Golf";

    public final static String STORAGE_NAME = "int_golf_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_int_golf, container, false);
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.int_golf_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.int_golf_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.int_golf_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.int_golf_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.int_golf_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.int_golf_view_btn_retry);
