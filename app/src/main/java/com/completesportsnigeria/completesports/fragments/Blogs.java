...
public class Blogs extends Fragment {
    ...
    public final static String TITLE = "Blog";
    public final static String STORAGE_NAME = "blog_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.blogs_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.blogs_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.blogs_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.blog_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.blogs_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.blogs_view_btn_retry);
