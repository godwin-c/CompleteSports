...
public class Competitions extends Fragment {
    ...
    public final static String TITLE = "Competitions";

    public final static String STORAGE_NAME = "competition_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.competitions__view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.competitions_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.competitions_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.competitions_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.competitions_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.competitions_view_btn_retry);
