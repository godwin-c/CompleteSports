...
public class LifeStyle extends Fragment {
    ...
    public final static String TITLE = "Life Style";

    public final static String STORAGE_NAME = "lifestyle_store";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar1 = (ProgressBar) view.findViewById(R.id.lifestyle_view_progressBar1);
        recyclerView = (RecyclerView) view.findViewById(R.id.lifestyle_view_recyclerview);
        internetNotAvailable = (LinearLayout) view.findViewById(R.id.lifestyle_view_internetNotAvailable);

        Config config = new Config();
        this.address = config.lifestyle_url;
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.lifestyle_view_swipeRefreshLayout);
        ...
        btnRetry = (Button) view.findViewById(R.id.lifestyle_view_btn_retry);
