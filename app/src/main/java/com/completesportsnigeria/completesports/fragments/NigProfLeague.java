...
public class NigProfLeague extends Fragment {


    public final static String TITLE = "NPFL";

    public final static String STORAGE_NAME = "nig_pro_league_store";
